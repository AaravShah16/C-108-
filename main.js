...
classifier = ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/CYeoCLdk8/model.json',modelLoaded)
...
if (error){
    ...
    if (results[0].label == "angry"){
        document.getElementById("update_emoji_1").innerHTML = "&#128545"
    }
